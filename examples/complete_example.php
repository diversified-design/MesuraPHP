...
$result = $originalHeight
    ->withValue(function($v) { return $v * 1.5; }) // Scale by 1.5
    ->toCentimeter() // Convert to cm
    ->withValue(function($v) { return $v + 10; }) // Add 10 cm
    ->toFoot() // Convert to feet
    ->withValue(function($v) { return round($v, 2); }) // Round to 2 decimal places
